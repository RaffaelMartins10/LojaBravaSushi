<!-- <div class="row">
	...
	<div class="col-sm-7">
		...
		<!-- De: <span class="price_from">€ <?php echo number_format($product_info['price_from'], 2); ?></span><br/> -->
		 <span class="original_price">€ <?php echo number_format($product_info['price'], 2); ?></span>
		...
		<form method="POST" class="addtocartform" action="<?php echo BASE_URL; ?>cart/add">
			...
			<input class="addtocart_submit" type="submit" value="<?php $this->lang->get('Aggiungi al Carrello'); ?>" />
		</form>
	</div>
</div>
<hr/>
