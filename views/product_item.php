<div class="product_item">
	<a href="<?php echo BASE_URL; ?>product/open/<?php echo $id; ?>">
		...
		<!-- <div class="product_category"><?php echo $category_name; ?></div> -->
		<div class="product_name"><?php echo $name; ?></div>
		<!-- <div class="product_brand"><?php echo $brand_name; ?></div> -->
		<div class="product_info"><?php echo $description;?></div>
		...
		?></div>
		<div class="product_price">€ <?php echo number_format($price, 2, ',', '.'); ?></div>
